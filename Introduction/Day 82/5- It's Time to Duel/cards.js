/**
 * No context is available for such a problem, but let's walk through it
 *
 */
...
unhandledPromiseRejection.applyEffect(redBelt);
...
pairProgramming.applyEffect(redBelt);
